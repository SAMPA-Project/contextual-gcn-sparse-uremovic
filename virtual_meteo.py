...
genuinely unobserved (virtual) stations. Always conditioned on the raster
context (this is the proposed method, not an ablation of it).

Run with no arguments to reproduce the original configuration exactly
(filters=128, khops=2, layers=3, virtual_ratio=0.33, every fold 0..8). Any
