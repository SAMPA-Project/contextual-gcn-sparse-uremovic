...
(filters=64, khops=2, layers=3, virtual_ratio=0.2, context-free ablation
variant, every fold 0..k-1). Any provided argument overrides just that value.
    ...
    python virtual_air.py --variant ctx             # context-conditioned variant
"""
...
def virtual_noctx(layers, khops, filters, virtual_ratio, k, ids_virtual, graph_real, metadata_real, graph_full, metadata_full):
    ...
    name = f'vn_air_noctx/vr={virtual_ratio}/l={layers}_k={khops}_f={filters}_lr={lr}/{k}'
